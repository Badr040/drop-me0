      ...
      <main className="flex-1 bg-background">
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-8">
            <h1 className="font-serif text-4xl md:text-5xl text-primary font-bold">CONTACT US</h1>
              ...
              <div className="bg-secondary/20 rounded-2xl p-6 flex flex-col justify-center">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <span className="text-sm text-foreground/80">+1 234 567 890</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="text-sm text-foreground/80">info@dropme.com</span>
                  </a>
                </div>
              </div>
          ...
          <div className="bg-card rounded-2xl shadow-sm p-8 max-w-4xl mx-auto">
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm text-foreground mb-2">Name / Surname</label>
                  <input
                    type="text"
                    placeholder="drew"
